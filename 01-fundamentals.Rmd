...
- **scalar** - no such thing, they are considered one element vector
...
**Atomic**
Variable is considered if the underlying data is basic element with the same type.
...
e4 = c(TRUE,TRUE,FALSE,TRUE)
sublist1 = list(20L,c('KK','SAL','WP'),c(T,T,F))
lst2 = list(e1=e1,e2=e2,e2=e3,e4=e4,sub=sublist1)
lst2
```
