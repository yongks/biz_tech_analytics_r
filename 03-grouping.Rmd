...
**aggregate** takes in a **data.frame**, computes and **output new data.frame**.  
...
#### Basic Syntax (formula method)
**aggregate (data=..., formula, FUN=function)  **
Formula in the form: **value~categorical**   
Parameter **data** is required. This eliminates the need to specify dataframe name for each variables.
