...
- After you learn **the power of dplyr**, you will forget about base R aggregate  
- Below is the example of two level grouping, and aggregated value calculation of mean, min and max, lastly with the row count for each group  
