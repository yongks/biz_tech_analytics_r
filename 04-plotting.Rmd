...
- In **ggplot/qplot**, variable variable y is the actual value, variable x is the group variable
- In **ggplot/qplog** case of one dimension, use x='' when no grouping is desired


```{r, message=FALSE, warning=FALSE, fig.show='hold', fig.width=2.5,fig.height=2.5}
...
```{r, echo=TRUE,fig.width=2.5, fig.height=2.5,fig.show='hold',message=FALSE}
