...
We will remove `D2` from the vector, but the level of `D2` exist !  
...
Load the library, display the original data.frame.  Split the data and verify the **logical vector** output.  
