...
confusion <- table(test$left, forest.pred, dnn=c("Actual", "Predicted"))
confusion
```
...
> `x       : model object of randomForest`  
> `by.tree : FALSE, default display per variable appearance, and not per tree`  
> `count   : TRUE, default aggregate all varibales appearance into frequency, otherwise display individual appearance`  
