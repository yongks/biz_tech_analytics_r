...
```{r}
pred.logit.train = predict(fit.logit, newdata = test, type = 'response')
head(pred.logit.train)
```

**Prediction on Training Data**  
Omitting **`newdata`** parameter, prediction default to training data.  
```{r}
pred.logit.test = predict(fit.logit, type = 'response')
